            ...
            <form action="{{ route('lector') }}" autocomplete="off" method="POST">
                ...
                <div class="container-entrada row mb-3 fs2">
                    ...
                    <div class="col col-8">
                        ...
                        <input type="text" class="input-matricula form-control fs3" id="input_matricula"
                            name="matricula">
                    </div>
                </div>
                ...
                <button class="btn btn-primary btn-entrar fs3 fw-bold w-25" id="btn_leer_entrada">Entrar</button>
            </form>

            <div class="mt-3">
                @if (session('success'))
                    <h6 class="alert alert-success">Ingreso correcto {{ session('success')[1] }} {{ session('success')[2] }}
                    </h6>
